        ...
        private void SetDomains5()
        {
            ...
            domainService.Setup(service => service.GetAll(It.IsAny<bool>()))
                .Returns((bool incWildcards) => new[]
                {
                    ...
                    new UmbracoDomain("http://domain1a.com/en") { Id = 2, LanguageId = LangEngId, RootContentId = 10011, LanguageIsoCode = "en-US", SortOrder = 1 },
                    new UmbracoDomain("http://domain1b.com/en") { Id = 3, LanguageId = LangEngId, RootContentId = 10011, LanguageIsoCode = "en-US", SortOrder = 2 },
                    new UmbracoDomain("http://domain1.com/fr") { Id = 4, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR", SortOrder = 0 },
                    new UmbracoDomain("http://domain1a.com/fr") { Id = 5, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR", SortOrder = 1 },
                    new UmbracoDomain("http://domain1b.com/fr") { Id = 6, LanguageId = LangFrId, RootContentId = 10012, LanguageIsoCode = "fr-FR", SortOrder = 2 },
                    new UmbracoDomain("http://domain3.com/en") { Id = 7, LanguageId = LangEngId, RootContentId = 10031, LanguageIsoCode = "en-US", SortOrder = 0 },
                    new UmbracoDomain("http://domain3.com/fr") { Id = 8, LanguageId = LangFrId, RootContentId = 10032, LanguageIsoCode = "fr-FR", SortOrder = 0 }
                });
        }
